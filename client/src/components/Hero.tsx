...
export default function Hero({ onShopNow }: HeroProps) {
  ...
  return (
    <section className="relative min-h-[85vh] flex items-center overflow-hidden bg-black pt-16 lg:pt-20">
      {/* Background image */}
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="max-w-2xl">
          ...
          <p className="text-[#aaa] font-body font-light text-base lg:text-lg leading-relaxed mb-8 max-w-md">
            Modelos atuais e retrôs de padrão premium com excelente acabamento, caimento impecável e riqueza de detalhes.
          </p>
